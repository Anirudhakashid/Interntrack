...
import { GraduationCap, FileText, Calendar, LogOut, Plus, CheckCircle, Clock, XCircle } from 'lucide-react'
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage your internship journey</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="forms">Internship Forms</TabsTrigger>
            ...
            {forms.length === 0 ? (
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No Internship Forms Yet</h3>
                    <p className="text-gray-600 mb-6">
                      Get started by submitting your first internship form for teacher approval.
                    </p>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your latest internship form submissions</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={form.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Teacher: {form.teacher.name}</p>
                          </div>
                        </div>
          ...
          <TabsContent value="forms" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-900">Internship Forms</h2>
              <Button onClick={() => setShowNewForm(true)}>
                <Plus className="w-4 h-4 mr-2" />
                New Form
              </Button>
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Teacher: {form.teacher.name} • Submitted {new Date(form.createdAt).toLocaleDateString()}
                          </CardDescription>
                        </div>
                        <Badge className={getStatusColor(form.status)}>
                          {form.status}
