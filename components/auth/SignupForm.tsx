    ...
    <div className={`min-h-screen bg-gradient-to-br ${theme.bg} flex items-center justify-center p-4`}>
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          <div className={`mx-auto w-12 h-12 bg-${theme.accent}-600 rounded-full flex items-center justify-center mb-4`}>
        ...
        <Card className="shadow-lg">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className={`w-full bg-${theme.accent}-600 hover:bg-${theme.accent}-700`} disabled={loading}>
                {loading ? (
                  <>
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <Link href={theme.loginPath} className={`text-${theme.accent}-600 hover:underline`}>
            Sign in
          </Link>
        </div>
      </div>
